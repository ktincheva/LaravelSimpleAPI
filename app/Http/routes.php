...
Route::group(array('prefix' => 'api'), function() {
	...
	Route::resource('candidates', 'CandidatesController');
        ...
        Route::post('apply','CandidatesController@apply');
        Route::post('applied', 'JoboffersController@applied');
        Route::post('selectCandidate', 'JoboffersController@selectCandidate');
